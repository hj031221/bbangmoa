...
test('getAvatarUrl: user_metadata.custom_avatar_url 이 최우선', () => {
  const user = { user_metadata: { custom_avatar_url: 'https://x/a.jpg' }, avatar_url: 'https://x/b.jpg' }
...
test('getAvatarUrl: user_metadata.custom_avatar_url 이 빈 문자열이면 폴백', () => {
  const user = { user_metadata: { custom_avatar_url: '' }, avatar_url: 'https://x/b.jpg' }
